...
class Student(SchoolMember):   #创建学生类（继承学校成员类）
    ...
    def show_student_info(self):
        ...
        Course:%s
        Course_price:%s
        """ % (stu1.member_name,stu1.stu_school,stu1.member_sex,
...
if __name__ == '__main__':
    ...
    s2 = School("马哥教育", "广州")
    course1 = Course("技术", "Linux", "11800", "6 month", "北京")
    course2 = Course("技术", "Python", "6400", "4 month", "北京")   #实例化三个课程
    course3 = Course("技术", "go", "2400", "4 month", "广州")
    courses_dict["Linux"] = course1
    courses_dict["Python"] = course2
    courses_dict["go"] = course3
    t1 = Teacher("Alex", "M", "33", "Python", "S13", "Oldboy")
    t2 = Teacher("mage", "M", "35", "linux", "魔鬼训练营", "mag")    #实例化两个讲师
    teachers_dict["Alex"] = t1
    teachers_dict["mage"] = t2
